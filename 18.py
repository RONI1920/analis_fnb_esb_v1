...
# #################################################################
    ...
    all_data_is_missing = (
        data_gmv is None and
        data_cogs is None and
        data_waiter is None and
        data_ulasan is None and
        data_purchase is None
    )
    ...
    # OPSI 2: Data GMV tidak ada, TAPI data lain ADA (tampilkan info box)
        ...
        st.title("Dashboard Analisis Data F&B")
        st.info("Mode analisis fleksibel. Data GMV tidak dimuat, beberapa filter/header mungkin nonaktif.")
